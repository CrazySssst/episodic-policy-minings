...
class EpisodeIterator(object):
    ...
    def iterate_over_episodes_in_file(self, file, condition):
        while True:
            ...
            info = episode['info']
            if condition(info):
                print(self.episode_number, self.total_number)
...
if __name__ == '__main__':
    ...
    '''
    #filenames =['/home/xupei/RL/rnd_model/MR/1_v2/logs/videos_0.pk']
 
    #filenames =['/home/xupei/RL/rnd_model/MR/FRND10/128_128_fixedscam_500_2/logs/videos_0.pk']
    #filenames =['/home/xupei/RL/rnd_model/MR/FRND9/rewroom/logs/videos_0.pk']
    filenames =['/home/xupei/RL/rnd_model/EC/ec_oracle_rnn/logs/videos_0.pk']
    #filenames =['/home/xupei/RL/rnd_model/GOAL/128_1gpu_1step_sum/logs/videos_0.pk']
    #filenames =['/home/xupei/RL/rnd_model/GOAL/128_1gpu_anchor_v2/logs/videos_0.pk']
    #filenames =['/home/xupei/RL/rnd_model/MR/FRND9/128_1gpu_v2/logs/videos_0.pk']
    #filenames =['/home/xupei/RL/rnd_model/MR/DIV/32_5_100M/logs/videos_0.pk']
    
    #filenames =['/home/xupei/RL/rnd_model/GOAL/128_1gpu_anchor_v2_1002_noPolicyGoal/logs/videos_0.pk']
